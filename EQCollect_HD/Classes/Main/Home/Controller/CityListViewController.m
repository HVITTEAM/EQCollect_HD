...
@interface CityListViewController (SearchCity)
...
@interface CityListViewController ()<UITableViewDataSource, UITableViewDelegate, MAHeaderViewDelegate>
{
...
- (void) tableView:(UITableView *)tableView willDisplayCell:(UITableViewCell *)cell forRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    {
        cell.backgroundColor = [UIColor colorWithRed:240/255.0 green:240/255.0 blue:240/255.0 alpha:1.0f];
    }
}
...
- (UIImage *)downloadImage
{
    if (_download == nil)
    {
        _download = [UIImage imageNamed:@"download_icon"];
    }
    return _download;
}
...
- (UIImage *)pauseImage
{
    if (_pause == nil)
    {
        _pause = [UIImage imageNamed:@"pause_icon"];
    }
    return _pause;
}
...
- (UIImage *)deleteImage
{
    if (_delete == nil)
    {
        _delete = [UIImage imageNamed:@"delete_icon"];
    }
    return _delete;
}
...
@implementation CityListViewController (SearchCity)
