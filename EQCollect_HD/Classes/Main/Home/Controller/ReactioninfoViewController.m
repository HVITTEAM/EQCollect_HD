...
- (void)viewDidLoad {
    ...
    self.navigationItem.title = @"人物反应详情";
    ...
    self.reactionidTextF.delegate = self;
    self.reactiontimeTextF.delegate = self;
    self.informantnameTextF.delegate = self;
    self.informantageTextF.delegate = self;
    self.informanteducationTextF.delegate = self;
    self.informantjobTextF.delegate = self;
    self.reactionaddressTextF.delegate = self;
    self.rockfeelingTextF.delegate = self;
    self.throwfeelingTextF.delegate = self;
    self.throwtingsTextF.delegate = self;
    self.throwdistanceTextF.delegate = self;
    self.fallTextF.delegate = self;
    self.hangTextF.delegate = self;
    self.furnituresoundTextF.delegate = self;
    self.furnituredumpTextF.delegate = self;
    self.soundsizeTextF.delegate = self;
    self.sounddirectionTextF.delegate = self;
}
...
-(void)rotationToInterfaceOrientation:(UIInterfaceOrientation)interfaceOrientation
{
    if(UIInterfaceOrientationIsLandscape(interfaceOrientation))
    {
        ...
        self.reactionidWidthCons.constant = 90;
    }
    //更新约束
