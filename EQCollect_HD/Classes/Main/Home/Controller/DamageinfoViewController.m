...
- (void)viewDidLoad {
    ...
    self.navigationItem.title = @"房屋震害详情";
    ...
    self.damageidTextF.delegate = self;
    self.damagetimeTextF.delegate = self;
    self.damageaddressTextF.delegate = self;
    self.damageintensityTextF.delegate = self;
    self.zrcorxqTextF.delegate = self;
    self.dworzhTextF.delegate = self;
    self.fortificationintensityTextF.delegate = self;
    self.damagesituationTextF.delegate = self;
    self.damageindexTextF.delegate = self;
}
...
-(void)rotationToInterfaceOrientation:(UIInterfaceOrientation)interfaceOrientation
{
    if(UIInterfaceOrientationIsLandscape(interfaceOrientation))
    {
        ...
        self.damageidWidthCons.constant = 90;
    }
    //更新约束
